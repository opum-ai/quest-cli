...
- Queue: 2 tasks; resolved: 1; in flight: 1; formally blocked or human-decision required: 0 task-semantic blockers.
...
- QCLI-65 is live `In Progress` in sequential wave 2 from verified base `7aad686a6c44e948adccd59911b09fc7c47af148`; QCLI-55 and QCLI-54 remain live `To Do` with no formal dependencies.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | QCLI-65 | decisions-docs | None | In flight | 2 | `docs/reference/quest-cli-open-component-decisions.md` | Narrow register-only correction; delivery roadmap must remain unchanged. |
