...
- In flight: none.
- Ready: QCLI-86 generic migration transaction engine.
...
| QCLI-86 | Ready | Depends only on completed QCLI-85; no known overlap with retained campaign artifacts. | Activate, plan, and implement the generic migration transaction engine. |
