...
| Task | Title | Status |
|---|---|---|
| [QCLI-72](../../backlog/tasks/qcli-72%20-%20Reconcile-and-freeze-the-Quest-0.1-implementation-baseline.md) | Reconcile and freeze the Quest 0.1 implementation baseline | To Do |
