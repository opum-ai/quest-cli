...
| [QCLI-23](../../backlog/tasks/qcli-23%20-%20Re-verify-QCLI-2.7-drift-table-against-lore-cli-v0.1.1-and-refresh-dependent-documents.md) | Re-verify QCLI-2.7 drift table against lore-cli v0.1.1 and refresh dependent documents | In Progress |
<!-- lore:tasks:end -->
