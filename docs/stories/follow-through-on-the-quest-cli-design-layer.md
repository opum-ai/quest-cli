...
| [QCLI-21](../../backlog/tasks/qcli-21%20-%20Reconcile-the-open-component-decisions-register-and-contracts-graph-against-the-QCLI-12..17-corrections.md) | Reconcile the open component decisions register and contracts graph against the QCLI-12..17 corrections | To Do |
