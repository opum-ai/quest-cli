...
| [QCLI-11](../../backlog/tasks/qcli-11%20-%20Record-quest-clis-activation-gate-evidence-and-decision-time.md) | Record quest-cli's activation-gate evidence and decision time | To Do |
<!-- lore:tasks:end -->
