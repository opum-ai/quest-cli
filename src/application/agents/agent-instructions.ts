...
export function checkQuestAgentInstructions(
  ...
  if (`${blocks[0]}\n` !== questAgentInstructions) {
    return {
      state: "drift",
      message: "Quest agent instruction block differs from version 0.2.6.",
    };
  }
